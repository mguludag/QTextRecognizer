...
public slots:
  void setIcons() {
    ...
    if (isDark) {
      ...
      icon.addFile(QString::fromUtf8(":/breeze-icons-master/icons-dark/actions/"
                                     "32/document-edit-decrypt-verify.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ...
      icon.addFile(QString::fromUtf8(":/breeze-icons-master/icons-dark/devices/"
                                     "22/drive-multipartition.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ...
      icon.addFile(QString::fromUtf8(
                       ":/breeze-icons-master/icons/actions/32/edit-undo.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ui->actionRotate_Left->setIcon(icon);
      icon.addFile(QString::fromUtf8(
                       ":/breeze-icons-master/icons/actions/32/edit-redo.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ui->actionRotate_Right->setIcon(icon);
      icon.addFile(
          QString::fromUtf8(
      ...
      ui->actionBest_Fit->setIcon(icon);
      icon.addFile(QString::fromUtf8(
                       ":/breeze-icons-master/icons/actions/32/zoom-in.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ui->actionZoom_In->setIcon(icon);
      icon.addFile(QString::fromUtf8(
                       ":/breeze-icons-master/icons/actions/32/zoom-out.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ui->actionZoom_Out->setIcon(icon);
      icon.addFile(
          QString::fromUtf8(
      ...
      icon.addFile(
          ...
          QSize(), QIcon::Normal, QIcon::Off);
      ui->actionClear_text->setIcon(icon);
      icon.addFile(QString::fromUtf8(":/breeze-icons-master/icons/actions/32/"
      ...
      ui->actionRotate->setIcon(icon);
      icon.addFile(QString::fromUtf8(
                       ":/breeze-icons-master/icons/actions/32/configure.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ui->actionSettings->setIcon(icon);
      icon.addFile(
          QString::fromUtf8(
          ...
          QSize(), QIcon::Normal, QIcon::Off);
      ui->actionAbout->setIcon(icon);
      icon.addFile(QString::fromUtf8(":/breeze-icons-master/icons/devices/22/"
                                     "drive-multipartition.svg"),
                   QSize(), QIcon::Normal, QIcon::Off);
      ui->actionAdjust_image->setIcon(icon);
      icon.addFile(
          QString::fromUtf8(
